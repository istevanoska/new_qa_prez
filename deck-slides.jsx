...
window.Sprint1GallerySlide = () => {
    ...
    const screenshots = [
        { src: "screenshots/sprint1/ss1.png",  label: "Laptop Test Cases",              rotate: -3  },
        { src: "screenshots/sprint1/ss2.png",  label: "Bug Report - Laptop",            rotate:  2  },
        { src: "screenshots/sprint1/ss3.png",  label: "Exploratory Testing",            rotate: -1  },
        { src: "screenshots/sprint1/ss4.png",  label: "Proper Defect Report - Laptop",  rotate:  4  },
        { src: "screenshots/sprint1/ss5.png",  label: "Research",                       rotate: -4  },
        { src: "screenshots/sprint1/ss6.png",  label: "Taiga Workspace",                rotate:  3  },
        { src: "screenshots/sprint1/ss7.png",  label: "Bug Report - Tablet",            rotate: -2  },
        { src: "screenshots/sprint1/ss8.png",  label: "Proper Defect Report - Mobile",  rotate:  5  },
        { src: "screenshots/sprint1/ss9.png",  label: "Tablet Test Cases",              rotate: -5  },
        { src: "screenshots/sprint1/ss10.png", label: "Bug Report - Mobile",            rotate:  2  },
    ];
